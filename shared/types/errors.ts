...
> = {
  ...
  [ErrorCode.INVALID_URL]: {
    ...
    helpText:
      "Make sure the URL starts with http:// or https:// and is accessible",
  },
  ...
  [ErrorCode.SCRAPING_FAILED]: {
    ...
    helpText:
      "The website might be private, require login, or block automated access",
  },
...
export interface UserFriendlyError {
  ...
  details?: unknown;
  timestamp: Date;
  // Additional context for usage limits
  currentUsage?: number;
  usageLimit?: number;
  membership?: string;
  upgradeUrl?: string;
...
export class ErrorMapper {
   ...
   */
  private static createError(code: ErrorCode): UserFriendlyError {
