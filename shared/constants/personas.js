 ...
 */
export const CLIENT_PERSONAS = Object.fromEntries(
  Object.entries(FULL_PERSONAS).map(([key, persona]) => [
    key,
    {
      id: persona.id,
 ...
 */
export function getClientPersona(id) {
 ...
 */
export function getAllClientPersonas() {
 ...
 */
export function getFullPersona(id) {
 ...
 */
export function getAllFullPersonas() {
