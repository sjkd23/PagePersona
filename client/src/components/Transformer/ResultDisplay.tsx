...
export default function ResultDisplay({ 
  ...
  const markdownComponents = {
    ...
    strong: ({...props}) => <strong className="result-markdown-strong dark:text-slate-100" {...props} />,
    ...
    blockquote: ({...props}) => <blockquote className="result-markdown-blockquote dark:text-slate-200" {...props} />,
    code: ({...props}) => <code className="result-markdown-code dark:text-slate-200" {...props} />
  }
  ...
  const modalMarkdownComponents = {
    ...
    blockquote: ({...props}) => <blockquote className="result-fullscreen-blockquote dark:text-slate-200" {...props} />,
    code: ({...props}) => <code className="result-fullscreen-code dark:text-slate-200" {...props} />
  }
