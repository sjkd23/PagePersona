      ...
      <div className="transformation-header">
        <div className="header-container">
          <div className="progress-steps">
            ...
            <div className="progress-separator">•</div>
            <div
              className={`progress-step ${state.content ? "step-result" : "step-pending"}`}
            >
          ...
          <div
            className={`step-card ${
              !state.selectedPersona
                ? "active"
                : state.selectedPersona &&
                    (!state.url.trim() || !actions.isValidInput())
                  ? "completed"
                  : "completed"
            }`}
          >
            <div className="card">
              <div className="card-header">
                <div className="step-header">
                  <span
                    className={`step-number ${state.selectedPersona ? "completed" : "active"}`}
                  >
                    1
                  </span>
                          ...
                          {state.personas.map((persona) => (
                            ...
                            >
                              ...
                              <div className="persona-info-small">
                                ...
                                <span className="persona-desc-small">
                                  {persona.description}
                                </span>
                              </div>
                ...
                {state.inputMode === "url" ? (
                  <div>
                    <input
                      ...
                      value={state.url}
                      onChange={(e) =>
                        actions.handleInputChange(e.target.value)
                      }
        ...
        {state.hasClickedGenerate && (
          <div className="results-row">
            ...
            <div className="result-card">
              <Suspense
                fallback={
                  <Spinner size="medium" message="Loading results..." />
                }
              >
                <ResultDisplay
