...
import { validateUrl, validateText, validateInput, formatUrl } from '../validation'
...
describe('validation utilities', () => {
  ...
  describe('validateText', () => {
    it('should accept text within length limit and above minimum', () => {
      const result = validateText('Hello world this is a long enough text for validation to pass', 100)
  ...
  describe('validateInput', () => {
    ...
    it('should validate text mode correctly', () => {
      const result = validateInput('This text content is long enough to meet the minimum character requirement of 50 characters', 'text', 100)
