...
describe('InputField', () => {
  ...
  describe('URL Mode', () => {
    it('should render TextInput when mode is url', () => {
      render(<InputField {...defaultProps} mode="url" value="https://test.com" />);
    ...
    it('should call onChange when URL input changes', () => {
      ...
      render(<InputField {...defaultProps} mode="url" onChange={mockOnChange} />);
    ...
    it('should show URL error when provided', () => {
      render(<InputField {...defaultProps} mode="url" urlError="Invalid URL format" />);
  ...
  describe('Text Mode', () => {
    it('should render TextArea when mode is text', () => {
      render(<InputField {...defaultProps} mode="text" value="Some text content" />);
    ...
    it('should call onChange when text input changes', () => {
      const mockOnChange = vi.fn();
      render(<InputField {...defaultProps} mode="text" onChange={mockOnChange} />);
    ...
    it('should show text error when provided', () => {
      render(<InputField {...defaultProps} mode="text" textError="Text is too long" />);
    ...
    it('should respect custom maxLength', () => {
      render(<InputField {...defaultProps} mode="text" value="Hello" maxLength={500} />);
  ...
  describe('Error Handling', () => {
    it('should apply error styling when URL has error', () => {
      render(<InputField {...defaultProps} mode="url" urlError="Invalid URL" />);
    ...
    it('should apply error styling when text has error', () => {
      render(<InputField {...defaultProps} mode="text" textError="Text too long" />);
    ...
    it('should show character count error styling when text has error', () => {
      render(<InputField {...defaultProps} mode="text" value="test" textError="Error" />);
  ...
  describe('Custom Styling', () => {
    it('should apply custom className', () => {
      const { container } = render(<InputField {...defaultProps} className="custom-input-field" />);
  ...
  describe('Error Priority', () => {
    it('should show URL error when in URL mode even if text error exists', () => {
      render(
        <InputField {...defaultProps} mode="url" urlError="URL error" textError="Text error" />,
      );
    ...
    it('should show text error when in text mode even if URL error exists', () => {
      render(
        <InputField {...defaultProps} mode="text" urlError="URL error" textError="Text error" />,
      );
