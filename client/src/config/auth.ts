...
export const domain = import.meta.env.VITE_AUTH0_DOMAIN || 'dev-hnoh845pekh6xkbd.us.auth0.com';
export const clientId = import.meta.env.VITE_AUTH0_CLIENT_ID || 'wRe1XsXoWeRCpEy526K8yLzGoWKhjlLt';
...
export const redirectUri = import.meta.env.VITE_SITE_URL || 
                          `${window.location.protocol}//${window.location.host}`;

export const audience = import.meta.env.VITE_AUTH0_AUDIENCE || 'https://pagepersonai.dev/api';
