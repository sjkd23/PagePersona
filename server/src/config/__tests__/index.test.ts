...
import { config, getConfig, dbConfig, auth0Config, jwtConfig, openaiConfig } from '../index';
...
describe('Config Module', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should work with different config values', () => {
      const testKeys = ['MONGODB_URI', 'AUTH0_DOMAIN', 'JWT_SECRET', 'OPENAI_API_KEY'] as const;
