...
import { serializeUser, safeLogUser, safeToISOString, safeDate } from '../utils/userSerializer';
...
export function testSerializeUser() {
  ...
  try {
    const result1 = serializeUser({} as any);
  ...
  try {
    ...
    const result2 = serializeUser(user2 as any);
  ...
  try {
    ...
    const result3 = serializeUser(user3 as any);
  ...
  try {
    ...
    const result4 = serializeUser(user4 as any);
  ...
  try {
    ...
    const result6 = serializeUser(user6 as any);
  ...
  console.log('\nTest 7: Null user');
  try {
    const result7 = serializeUser(null as any);
