...
describe('Auth0 Middleware - Core Functionality', () => {
  ...
  describe('verifyAuth0Token re-export', () => {
    it('should re-export the JWT verification function', async () => {
      ...
      const { verifyAuth0Token } = await import('../middleware/auth0-middleware')
  ...
  describe('syncAuth0User basic cases', () => {
    ...
    it('should set user context when successful', async () => {
      ...
      const mockMiddleware = vi.fn(async (req: Partial<Request> & { user?: any; userContext?: any }, res: Response, next: NextFunction) => {
  ...
  describe('Error handling', () => {
    ...
    it('should return error for non-user routes', async () => {
      ...
      const mockMiddleware = vi.fn(async (req: Partial<Request> & { user?: any; userContext?: any; path?: string }, res: Partial<Response>, next: NextFunction) => {
        try {
