...
async function testIntegration() {
  ...
  const mockTransformResult = {
    ...
    transformedContent:
      "This is the transformed content in the requested persona style.",
    persona: {
      id: "casual",
      name: "Casual",
  ...
  try {
    ...
    console.log(
      "Cache hit result:",
      cachedResult2 ? "✅ Found data" : "❌ No data",
    );
    ...
    if (cachedResult2) {
      ...
      console.log(
        ...
        cachedResult2.transformedContent.length,
      );
    ...
    const textCachedResult1 = await getCachedTextTransformResult(
      testText,
      testPersona,
    );
    console.log(
    ...
    const textCachedResult2 = await getCachedTextTransformResult(
      testText,
      testPersona,
    );
    console.log(
      "Text cache hit result:",
      textCachedResult2 ? "✅ Found data" : "❌ No data",
    );
    ...
    if (textCachedResult2) {
      ...
      console.log(
        "  - Content Length:",
        textCachedResult2.originalContent.content.length,
      );
      console.log(
        "  - Word Count:",
        textCachedResult2.originalContent.wordCount,
      );
    ...
    console.log(
      "- Text transforms use: transform:text:{persona}:{base64_text_sample}",
    );
