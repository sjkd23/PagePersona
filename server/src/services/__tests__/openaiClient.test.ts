...
describe("OpenAIClientService", () => {
  ...
  describe("constructor", () => {
    ...
    it("should throw error with empty API key", () => {
      expect(() => new OpenAIClientService("")).toThrow(
        "OpenAI API key is required",
      );
    });

    it("should throw error with null API key", () => {
      expect(() => new OpenAIClientService(null as any)).toThrow(
        "OpenAI API key is required",
      );
    });
  });
  ...
  describe("generateCompletion", () => {
    ...
    it("should handle OpenAI API errors", async () => {
      ...
      await expect(
        openaiService.generateCompletion(mockRequest),
      ).rejects.toThrow(
  ...
  describe("error handling and edge cases", () => {
    ...
    it("should validate prompt parameters", async () => {
      ...
      await expect(
        openaiService.generateCompletion(invalidRequest),
