...
describe('PromptBuilderService', () => {
  ...
  describe('buildTransformationPrompt', () => {
    ...
    it('should throw error for unknown persona', () => {
      expect(() =>
        PromptBuilderService.buildTransformationPrompt(mockContent, 'unknown-persona'),
  ...
  describe('buildTextTransformationPrompt', () => {
    ...
    it('should throw error for unknown persona in text transformation', () => {
      expect(() =>
        PromptBuilderService.buildTextTransformationPrompt(mockContent, 'invalid'),
  ...
  describe('error handling', () => {
    it('should handle null persona gracefully', () => {
      expect(() =>
        PromptBuilderService.buildTransformationPrompt(mockContent, 'null-persona'),
