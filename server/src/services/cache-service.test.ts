...
describe('CacheService', () => {
  ...
  describe('Transformation Caching', () => {
    ...
    it('should distinguish between different personas for same URL', () => {
      ...
      const result1 = { ...mockTransformationResult, persona: { ...mockTransformationResult.persona, id: persona1 } }
      const result2 = { ...mockTransformationResult, persona: { ...mockTransformationResult.persona, id: persona2 } }
    ...
    it('should distinguish between different URLs for same persona', () => {
      ...
      const personaId = 'professional'
      const result1 = { ...mockTransformationResult, originalContent: { ...mockTransformationResult.originalContent, url: url1 } }
      const result2 = { ...mockTransformationResult, originalContent: { ...mockTransformationResult.originalContent, url: url2 } }
  ...
  describe('Cache Management', () => {
    it('should clear scrape cache independently', () => {
      ...
      expect(cacheService.getCachedTransformation(url, personaId)).toEqual(mockTransformationResult)
    })
