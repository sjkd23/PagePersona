 ...
 */
export function safeGetAuth0Claims(auth0User: any): SafeAuth0Claims {
  if (!auth0User) {
 ...
 */
export function safeGetCustomClaims(auth0User: any) {
  if (!auth0User) {
    return {};
  }
 ...
 */
export function safeGetEmail(auth0User: any): string | null {
 ...
 */
export function safeGetDisplayName(auth0User: any): string {
 ...
 */
export function validateAuth0User(auth0User: any): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 */
export function debugAuth0Claims(auth0User: any, userId?: string): void {
