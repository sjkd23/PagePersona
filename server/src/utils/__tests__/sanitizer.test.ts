...
describe('Sanitizer Utility', () => {
  describe('sanitize()', () => {
    ...
    it('should remove iframe tags', () => {
      const iframeContent = '<iframe src="https://malicious.com"></iframe><p>Safe content</p>';
  ...
  describe('sanitizeText()', () => {
    it('should encode HTML entities', () => {
      const textWithHtml = '<script>alert("XSS")</script> & "quotes" & \'apostrophes\'';
  ...
  describe('sanitizeUserInput()', () => {
    it('should allow only basic formatting tags', () => {
      const userInput = '<p>This is <strong>bold</strong> and <em>italic</em> text</p>';
    ...
    it('should remove all attributes from user input', () => {
      const inputWithAttrs = '<p class="danger" id="test" onclick="alert(1)">Content</p>';
